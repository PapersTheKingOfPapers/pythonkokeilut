...
'''
This code is a copy from our flight game.

Make a file with the name "db.json" in the same folder as this script.
The contents of said file should match the example below, with 'USERNAME' being your username.
'PASSWORD' should be your password for the db as well.
